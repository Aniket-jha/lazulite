...
const ContactForm = () => {
  return (
    <div className='mt-[-180px] pb-12 px-48' >
         <div className='flex mb-12  items-center justify-center mt-6 gap-12' >
        <div className='flex bg-[#1e31b1] pl-2 pr-4 py-2 rounded-[50px] items-center justify-center gap-4'>
                    <img src={EmailImage} />
